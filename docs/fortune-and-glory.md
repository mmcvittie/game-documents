...
*Pulp adventures in a world of ancient mysteries and lost treasures*

From neon-lit alleys to crumbling jungle temples, step into a race against time and tyranny where fortune favours the bold and the only thing more dangerous than the traps you trigger are the rivals on your heels.
...
**Resistance Save:** Roll against ongoing/inner effects (e.g. environmental effects, stuns, afflictions, Mystical or mental effects).
...
| **Second Sight** | You can see through illusions and disguises automatically. Can identify cursed objects and detect lies/hidden doors/traps on anything but a 1, and perceive the true nature of disguised beings. However, each time you encounter an evil Mystical entity, you must make a Resistance Save to avoid being overwhelmed by visions and becoming Terrified. |  |
...
| Ability | Description | Boons |
|---------|-------------|-------|
| **Bind Mind** | As an Action, choose a target you can physically touch to put under your complete control until the end of the scene on anything but a 1. They make an initial Resistance Save, and if they succeed, they get a free attack on you with a Boon. They can make a Resistance Save at the end of each subsequent turn to try and shake off the effect. If you perform another Mystical Action, suffer a Condition, or are killed, the effect ends. |  |
| **Curse** | As an Action, invoke a curse upon an enemy you can see on anything but a 1. They must make a Resistance Save or be Afflicted(Curse), if they succeed, you take a Strike from the backlash. |  |
| **Simulacrum** | If you possess a personal item from someone, you can create a Mystical doll. Once per session, inflict 1 Strike on them from any distance, but they get to make a Resistance Save and if they pass, you take 1 Strike yourself from the dark powers. |  |
| **Shade Step** | As an Action, step into shadows and emerge from another shadow within Far Range that you can see on anything but a 1. Can spend 1 Grit per person touching you to bring them along. |  |
| **Cloak of Shadows** | As an Action, wrap yourself in living shadow for the duration of the scene on anything but a 1. While cloaked, enemies have a Bane to Detecting/Spotting against you and you gain a Boon to Stealth and Hiding anywhere there is shadow. You can spend 1 Grit per teammate to extend the cloak to them. On a 1 the things that lurk in the shadows infiltrate your mind and you are Terrified. |  |
| **Leech** | As an Action, target a single enemy you can see who must make a Resistance Save on anything but a 1. If they fail, they lose 1 Strike and you can distribute that as healing to yourself or a teammate you can see. If they pass, you are Incapacitated from the backlash. |  |
| **Necromancy** | As an Action, target a corpse within Far Range that you can see to raise as an undead minion on anything but a 1. It has 2 Strikes, can make basic melee attacks, and perform basic tasks at your direction. On a 1, the corpse is instead re-animated as a hostile undead creature that attacks you and your allies. You can have up to 6 of these minons at any time. |  |
...
| **Alcohol** | Useful for stress relief and false courage. Gain +1 Grit when used. If used more than once per day, take a Bane on all Actions until the end of the next scene. | 3 | Common |
...
| **Fresh Food** | Perishable food that provides better nourishment, heal an extra +1 Strike with rest, or gain +1 Grit if your health is full. Require 1 Ration per day to heal a Strike overnight. | 1 | Common |
...
| **Butterfly Net** | For capturing small creatures and insects. | 1 | Common |
| **Camera** | Document discoveries and gather evidence. Limited film. | 1 | Rare |
| **Cigar Case** | Silver case. Useful for bribery, reflecting light/signals, or stopping stray bullets. | 1 | Uncommon |
| **Code Book** | Secret cipher for encoding and decoding messages. | 1 | Rare |
| **Compass** | Navigation tool. Essential for wilderness travel. | 1 | Common |
| **Disguise Kit** | Makeup, wigs, and accessories for creating disguises. | 1 | Uncommon |
| **Diving Suit** | Heavy underwater suit with air hose. Allows underwater exploration for extended periods. | 1 | Rare |
| **Duct Tape** | Roll of heavy-duty tape. Fixes almost anything. | 1 | Common |
| **Fedora** | Iconic adventurer's hat. Once per session, sacrifice it dramatically to avoid a Strike. | 1 | Uncommon |
...
| **Gramophone** | Large record player. | 1 | Uncommon |
...
| **Hip Flask** | Silver flask, easily concealed. | 1 | Common |
| **Journal** | Record discoveries, maps, and clues. | 1 | Common |
...
| **Pith Helmet** | Colonial explorer's helmet. Protects from sun and falling debris. | 1 | Common |
...
| **Spyglass** | Compact telescope for naval use and long-distance viewing. | 1 | Uncommon |
| **Stethoscope** | Medical tool. Also useful for safecracking. | 1 | Uncommon |
| **Stopwatch** | Precision timepiece for timing explosives or coordinating actions. | 1 | Uncommon |
| **Towel** | Never leave home without it. Multipurpose cloth. | 1 | Common |
| **Translator Guide** | Phrasebook for foreign languages. | 1 | Common |
| **Tripwire Alarm** | Simple alarm system. Alerts when triggered. | 3 | Common |
| **Typewriter** | Portable writing machine for reports and correspondence. | 1 | Uncommon |
| **Umbrella** | Good for keeping the rain off. | 1 | Common |
| **Walkie-Talkie** | Two-way radio for team communication at Long Range. | 1 | Common |
| **Whistle** | Loud signaling device. | 1 | Common |
...
| **Pet Monkey** | Clever primate companion, that often gets itself into mischief. Boon to Climbing and Pickpocketing. Can retrieve items from difficult locations. Distracts enemies on command, but when given a command, roll a Resistance Save for the monkey. If it succeeds, it does something mischievous instead of following your command directly. | Small |
