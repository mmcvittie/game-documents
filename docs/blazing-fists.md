...
| Ability | Description | Boons |
|---------|-------------|-------|
| **Necromantic Arts** | As an Action, target a corpse within Far Range to raise as an undead minion. It has 2 Strikes, can make basic melee attacks, and perform basic tasks at your direction. The first time you use this ability each session, or start a session with any minions, make a Resistance Save or take 1 Corruption. You can have up to 6 of these minons at any time. |  |
