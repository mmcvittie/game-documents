# GEMS: Generic EZD6 Modular System

*A streamlined, classless hack of EZD6*
...
|------|-------------|---------|-------|--------|
| **One-Handed Melee Weapon** | Standard one-handed melee weapon. Reliable and versatile. | 1 | Close | Common |
| **Shield** | Defensive tool that provides a Boon to one Armour Save per turn when equipped. Can be sacrificed to ignore a Strike. | - | - | Common |
| **Two-Handed Melee Weapon** | Standard two-handed melee weapon. Powerful but less versatile. | 1 | Close | Common |

### Ranged Weapons

| Name | Description | Strikes | Range | Rarity |
|------|-------------|---------|-------|--------|
| **One-Handed Ranged Weapon** | Standard one-handed ranged weapon. Reliable and versatile. | 1 | Close | Common |
| **Two-Handed Ranged Weapon** | Standard two-handed ranged weapon. Powerful but less versatile. | 1 | Close | Common |
...
|------|-------------|-------|
| **Light Vehicle** | Fast, maneuverable transport for individual use. Boon to Evasion and can move 2 Movement Zones per Action in open terrain. | Small |
| **Medium Vehicle** | Standard transport for individuals or small groups. Can carry up to 4 passengers and provides Light Cover. | Medium |
| **Heavy Vehicle** | Durable transport designed to carry multiple passengers or cargo into battle. Can carry up to 6 passengers and provides Medium Cover. Boon to Ramming attacks. | Large |
| **Superheavy Vehicle** | Massive vehicle designed to transport troops or heavy equipment across the battlefield. Can carry up to 8 passengers and provides Heavy Cover. Ignores difficult terrain and can bulldoze obstacles. | Huge |
| **Light Chariot** | Lightweight wheeled vehicle for swift travel and racing. Boon to Speed. Carries one driver. Requires two animals to pull. | Medium |
| **War Chariot** | Reinforced combat chariot for battlefield superiority. Can make charging attacks. Provides light protection. Carries a driver and warriors. Requires multiple animals. | Large |

### Vehicle Upgrades

| Upgrade | Description |
|---------|-------------|
| **Pack Coordination** | Trained to work with others. Boon to coordinated maneuvers. |
| **Cargo Platform** | Enhanced carrying capacity for equipment, supplies, or passengers. |
| **Healing Station** | Traveling medical supplies. Can restore 1 Strike to rider during rest. |
| **Signal Training** | Responds to complex commands. Boon to tactics and coordination. |

### Companions

| Name | Description | Class |
|------|-------------|-------|
| **Light Mount** | Agile, sure-footed mount suited to scouting and fast travel. Boon to Speed and Agility. Can outrun Medium mounts. | Small |
| **Medium Mount** | Reliable riding beast trained to stay calm in danger. Boon to Endurance and can carry one rider plus gear. | Medium |
| **Heavy Mount** | Armoured or exceptionally tough mount built for frontline use. Boon to Armour Saves and Melee Attacks. Can carry up to two riders. | Large |
| **Behemoth Mount** | Gigantic mount capable of carrying a small crew or howdah into battle. Causes Terror in enemies who fail a Resistance Save. Can carry up to 4 passengers and provides Medium Cover. | Huge |
| **Companion Creature** | Loyal animal companion trained to assist. Boon to Tracking or Sensing. Takes 2 Actions per turn but requires 1 of your Actions to command. | Small |
| **Combat Companion** | Trained beast or construct for battle support. Boon to Melee Attacks. Takes 2 Actions per turn but requires 1 of your Actions to command. | Medium |
