...
*Savage prehistoric adventures in a world of flint and megafauna*

At the dawn of an age of bone and blood, forge your legend in a primordial land of savagery and giant beasts, where your only survival lies in the strength of your tribe and the sharpness of your flint.
...
|------|-------------|---------|-------|--------|
| **Bone Dagger** | Pointed bone blade. Useful as weapon and tool. Easily concealed. | 1 | Close | Common |
| **Bone Spear** | Bone-tipped spear. Effective hunting weapon. Can be used in melee or thrown. | 1 | Close/Near | Common |
| **Flint Dagger** | Sharp flint blade hafted to bone or wood. Easily concealed. | 1 | Close | Uncommon |
| **Hide Shield** | Defensive tool that provides a Boon to one Armour Save per turn when equipped. Can be sacrificed to ignore a Strike. | - | - | Common |
| **Obsidian Club-Sword** | Large wooden club lined with razor-sharp obsidian shards. Inflicts grievous wounds. On a confirmed Crit, inflict Afflicted (Bleeding). | 1 | Close | Rare |
| **Sharpened Claws** | Sharpened beast claws attached to hands. Boon to Climbing and Grappling. | 1 | Close | Rare |
| **Stone Axe** | Basic one-handed stone tool and weapon. Boon to Cutting Wood and against Unarmoured targets. | 1 | Close | Uncommon |
| **Stone Club** | Heavy stone lashed to wooden handle. Boon to Breaking and against Armoured targets. | 1 | Close | Uncommon |
| **Stone Hammer** | Large stone bound to handle useful as a tool and weapon. Boon to Hammering and against Armoured targets. | 1 | Close | Uncommon |
| **Stone Mace** | Heavy stone attached to a short, one-handed shaft. On a Confirmed Crit, inflict Stunned. | 1 | Close | Rare |
| **Stone Spear** | Stone-tipped spear. Can be used in melee or thrown. Boon to Melee Attacks. | 1 | Close/Near | Uncommon |
| **Wooden Club** | Sturdy hardwood club. Simple but effective bludgeon. | 1 | Close | Common |

### Ranged Weapons

| Name | Description | Strikes | Range | Rarity |
|------|-------------|---------|-------|--------|
| **Blow Gun** | Hollow tube for shooting darts. Silent. Inflicts no damage, but on a hit the target is Afflicted (Poison). | 0 | Near | Rare |
| **Boomerang** | Carved throwing stick that returns. | 1 | Long | Rare |
| **Bow** | Simple wooden bow. Essential hunting weapon. | 1 | Long | Uncommon |
| **Javelins** | Stone-tipped wooden javelins for throwing. | 1 | Near | Common |
| **Sling** | Leather cord and pouch. Ancient ranged weapon. | 1 | Long | Common |

### Equipment

| Name | Description | Quantity | Rarity |
|------|-------------|----------|--------|
| **Animal Fat** | Rendered grease for waterproofing, lubrication, or as lamp fuel. | 1 | Common |
| **Bone Dice** | Carved knucklebones for gambling, divination, or entertainment during downtime. | 1 | Common |
| **Bone Grapple** | Braided sinew rope with a carved antler or bone hook for vertical climbing or crossing gaps. | 1 | Common |
| **Bone Pins** | Sharpened bone slivers for construction, trapping, or securing objects. | 1 | Common |
| **Colored Glass Beads** | Shiny trinkets that resemble precious stones, useful for deception or barter. | 1 | Uncommon |
| **Flint Chisel** | Knapped flint edge for carving wood, scoring stone, or precise cutting work. | 1 | Common |
| **Hunting Tools** | Specialized implements for tracking, trapping, or gathering - bone hooks, flint scrapers, or snare wire. | 1 | Common |
| **Javelin Thrower** | Wooden device that extends throwing range of javelins. Can throw javelins up to Long Range with a Boon to the attack. | 1 | Uncommon |
| **Obsidian Mirror** | Polished disc for looking around corners, signaling, or checking appearance. | 1 | Uncommon |
| **Oil Lamp** | Hollowed stone filled with animal fat and moss wick. Provides light up to Near Range that can be easily covered or extinguished. | 1 | Common |
| **Pry Bar** | Hardwood lever reinforced with bone for prying open barriers or secured items. | 1 | Common |
| **Scent Pouch** | Dried flowers and aromatic herbs for masking odors or ritual purposes. | 1 | Common |
| **Sharpened Stakes** | Fire-hardened wooden stakes for climbing, securing, or setting traps. | 1 | Common |
| **Spirit Totem** | Carved fetish or painted bone that provides spiritual strength and tribal authority. | 1 | Uncommon |
| **Thorn Scatter** | Sharpened thorns and bone fragments that slow or injure those who step on them. | 1 | Common |
| **Torch** | Pitch-soaked branch wrapped in dried moss. Provides light up to Near Range in dark environments. | 1 | Common |
| **War Paint** | Clay, ochre, and charcoal pigments for ritual decoration, intimidation, or disguise. | 1 | Common |
| **Whistle** | A loud signaling device for communication or alerting others. | 1 | Common |
...
| **Darts** | Small projectiles for blow guns. | 12 | Common |
| **Stones** | Small stones for slings. | 12 | Common |
...
|------|-------------|-------|
| **Nimbleclaw** | Agile pack hunter, trained for scouting and quick strikes. Boon to Tracking and Stealth. Gain a bonus Attack when striking from a hidden position. | Small |
| **Spearfisher** | Flying hunter with a sharp beak, ideal for aerial reconnaissance. Boon to Tracking and Aerial Maneuvers. Can fly and dive to strike with precise attacks. | Small |
| **Reedskitter** | Small insectoid hunter with chitinous plates. Boon to Stealth and Agility. Can move silently across water and marsh without sinking or leaving tracks. | Small |
| **Streamfin** | Swift aquatic hunter with sleek hide and razor teeth. Boon to Melee Attacks and Agility. Can move two Movement Zones per Action through water and leap from the surface to strike targets. | Small |
| **Dread Tyrant** | Apex predator of tremendous size and ferocity. Double boon to Melee Attacks. Causes Terror in enemies who fail a Resistance Save. Allows only a single bonded rider. | Huge |
| **Burnspitter** | Small acid-spitting hunter with bony frills. Boon to Stealth and Speed. Once per scene, can spit acid as a Ranged Attack that inflicts 1 Strike and Afflicted (Acid). Companion only, too small to carry riders. | Small |
| **Swiftrunner** | Fleet-footed beast, good for traversing difficult terrain. Boon to Speed and +1 To-Hit while moving. Can carry one rider who benefits from the +1 To-Hit also. | Medium |
| **Treehopper** | Agile leaping beast capable of scaling cliffs and forests. Boon to Agility. Leaping attacks from height inflict Knocked Down on a Crit. Can carry one passenger on its back. | Medium |
| **Fangmaw** | Predator bred for killing. Boon to Intimidation and Melee Attacks. Once per scene, can howl to inflict Terror on all Close enemies who fail a Resistance Save. Can carry one rider. | Medium |
| **Ironfoot** | Powerful thick-limbed beast capable of bearing heavy loads. Boon to Endurance and has additional carrying capacity. Can carry one rider plus heavy packs, or an additional rider. | Large |
| **Whistlehorn** | Large crested beast that calls to its herd with haunting cries. Can signal others over long distances. Once per scene, can grant a Boon to the next Resistance Save of all allies within earshot. Can carry one rider. | Large |
| **Skyclaw** | Agile winged predator with powerful talons. Boon to Aerial Maneuvers and Grappling. Can dive from height to snatch enemies. Can carry one rider. | Medium |
| **Burrowmandible** | Tunneling creature that ferries riders beneath the earth. Boon to Stealth while burrowing. Can tunnel short distances to bypass obstacles. Can carry one rider. | Medium |
| **Silkwarden** | Many-legged predator with shimmering web-silk. Boon to Climbing and web-based mobility. Can move across vertical surfaces and create barriers from sticky webbing. Can carry one rider on its carapace. | Medium |
| **Razormane** | Apex hunter with a ferocious bite. Boon to Melee Attacks and Observation. Can leap two Movement Zones in a single Action and carry one rider. | Medium |
| **Veilstrike** | Sinuous venomous creature with iridescent scales. Boon to Stealth and Grappling. On a Crit, inflicts Afflicted (Venom), dealing 1 Strike each turn until cured. Can carry one rider. | Medium |
| **Wavestalker** | Predatory swimmer with powerful flippers and elongated jaws. Boon to Stealth while submerged and Melee Attacks in water. Can drag grappled targets underwater. Can carry one rider who must be able to breathe underwater or hold their breath. | Large |
| **Clubtail** | Heavily armoured beast with a devastating tail club. Boon to Saves against Attacks. Attacks inflict Knocked Down on a Crit. Can carry up to two riders. | Large |
| **Trihorn** | Three-horned giant used for charging into battle. Can make a Charging Attack from Near which inflicts Knocked Down on success. Riders benefit from Light Cover behind its frill against frontal Ranged Attacks. Can carry up to two riders. | Huge |
| **Spineplate** | Plated beast with spiked tail for defense. Boon to Armour Saves for riders. If a Melee Attacker rolls a 1 on their attack, they take 1 Strike from the spines. Can carry up to two riders. | Huge |
| **Stonegrip** | Massive knuckle-walking beast that climbs sheer faces and hurls stones. Boon to Strength. On a Crit, inflicts Stun. Can hurl boulders as a Ranged Attack. Can carry up to two passengers, one in each arm. | Huge |
| **Amberwing** | Massive winged insect with shimmering chitinous plates. Boon to Aerial Maneuvers and Observation. Can carry up to two passengers while flying. Swooping attacks gain advantage on Crit rolls. | Medium |
| **Dawncarapace** | Domed chitinous behemoth that pushes through obstacles. Boon to Armour Saves. Can bulldoze obstacles and grants Light Cover to riders. Can carry up to two riders. | Huge |
| **Tidecrusher** | Massive marine predator with crushing jaws and armoured hide. Boon to Strength. Can breach from underwater to make devastating attacks, gaining +1 Strike on a Crit. Can carry up to two riders who must be able to breathe underwater or hold their breath. | Huge |
| **Frostmane** | Towering tusked colossus draped in shaggy hide and bearing a war howdah. Causes Terror in enemies who fail a Resistance Save. Stomping attack inflicts Knocked Down to all Close enemies on success. Carries a howdah (Light Cover) with up to four passengers. | Large |
| **Longneck** | Gigantic towering beast serving as a mobile fortress. Elevated vantage grants Boon to Ranged Attacks from its back. Can ford rivers and ignore difficult ground. Carries a fortified platform (Medium Cover) with up to six passengers. | Huge |
| **Thunderwing** | Colossal flying beast with a deafening screech and powerful wings. Boon to Intimidation. Can carry up to four passengers while flying. Its screech inflicts Stun on enemies who fail a Resistance Save. | Large |
| **Siegeshell** | Towering chitin colossus with a ramped back and powerful mandibles. Boon to attacking Structures and Large and Huge enemies. Ignores difficult terrain. Carries a platform (Medium Cover) with up to six passengers. | Huge |
| **Depthcaller** | Colossal deep-sea leviathan with a cavernous maw and ancient intelligence. Causes Terror in enemies who fail a Resistance Save. Can swallow Medium or smaller enemies whole on a Crit. Can carry up to four passengers who must be able to breathe underwater or hold their breath. | Huge |

### Companion Upgrades

| Upgrade | Description |
|---------|-------------|
| **Speed Boost** | Speed training regimine. Companion can run at the same speed as mounts one class smaller for a scene once per day. |
| **Camouflage Paint** | Natural pigments and patterns. Boon to Stealth. |
| **Armour** | Specialised armour for extra durability. Boon to Saves from physical damage. |
| **Trained Hunter** | Enhanced awareness and tracking ability. Boon to Sensing. |
| **Battle Fury** | Once per session, automatically confirm a failed Crit Confirm. |
| **Herd Instinct** | Trained to work with pack. Boon to Coordinated Maneuvers. |
| **Pack Saddle** | Reinforced harness for carrying equipment, supplies, or trade goods. Doubles your gear capacity. |
